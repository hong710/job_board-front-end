...
function Header({text="Current Openings",hidden}) {
  return (
    ...
    <div>
        ...
        <div className={`h-[calc(100vh-60vh)] relative bg-custom`}>
            
            <div className=''>
                <img src={banner} alt='linked' className={`w-full h-[calc(100vh-60vh)] object-cover`}/>
        ...
        <div className={`w-screen bg-[#F3F4F8] py-8 ${hidden}`}>
